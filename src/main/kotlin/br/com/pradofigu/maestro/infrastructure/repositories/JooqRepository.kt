...
internal interface JooqRepository<T : Record> {
    ...
    // Sets the column change to false when the value didn't change, avoiding updating all columns unnecessary.
    // Feature suppose to be introduced on JOOQ-3.19V (https://github.com/jOOQ/jOOQ/issues/5394)
